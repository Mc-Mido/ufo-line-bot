...
{
    private final Logger log = LoggerFactory.getLogger(TagallApplication.class);
    ...
    {
        log.info("event uf0: " + event);
        final String originalMessageText = "[Ufo bot] " + event.getMessage().getText();
